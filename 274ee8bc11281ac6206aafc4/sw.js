const CACHE='session-lowell-shell-v1';
const SHELL=['./','./index.html','./style.css','./app.mjs','./core.mjs','./parks.mjs','./vendor/leaflet.js','./vendor/leaflet.css','./icon.svg','./manifest.webmanifest'];
